...
I originally tried using pointers but the grid never actually updated. Not sure why.
...
Note that this should work fine for my case, where the original QList is on the parent
of the QAbstractTableModel. This means the original QList can never disappear before
the QAbstractTableModel.

If you have the QList on some other object, that is not the parent of the QAbstractTableModel,
